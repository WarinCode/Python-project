...
class Program:
    ...
    KEYWORDS = ("e", "c", "m", "b", "a", "d", "ed", "cl", "exit",
                "commands", "menu", "buy", "add", "delete", "edit", "clear")
    ...
    def __init__(self, menu, table):
        ...
        self.commandsTable.add_column("ความหมายของคำสั่ง", ("ออกจากโปรแกรม", "แสดงคำสั่ง", "แสดงเมนูอาหาร",
                                      "สั่งซื้อสินค้า", "เพิ่มรายการสินค้า", "ลบรายการสินค้า", "แก้ไขชื่อรายการสินค้า", "ลบรายการสินค้าทั้งหมด"))
        self.setElements()
        self.showCommands()
    ...
    def greeting(self):
        # * วันที่
        days = ("จันทร์", "อังคาร", "พุธ", "พฤหัสบดี",
                "ศุกร์", "เสาร์", "อาทิตย์")
    ...
    def createID(self, length=4):
        ...
        def rand(): return str(floor(id({}) * randint(1, 100)))
        while True:
    ...
    def showMenu(self):
        ...
        self.menuTable.field_names = (
            'ลำดับ', 'อาหาร', 'ราคา(บาท)', 'รหัสสินค้า')
        n = 1
        for item in self.menu:
            ...
            n += 1
        print(f'🌟 ตอนนี้ไม่มีรายการสินค้าใดๆโปรดเพิ่มสินค้าก่อนแสดงรายการเมนู!') if self.menu.__len__(
        ) == 0 else print('\n', self.menuTable, '\n')
    ...
    def placeOrder(self):
        ...
        while self.programStatus["isInvokeMethods"]:
            try:
                ...
                elif (foodName not in self.foodList) and (not (foodName == "end" or foodName == "e")):
                    raise UserWarning(
            ...
            if foodName == "end" or foodName == "e":
                ...
                for item in self.currentOrder:  # loop รายชื่ออาหารที่ทำการสั่งหมด
                    ...
                    self.currentOrder[item] = (
                        self.currentOrder[item] * self.menu[idx]["price"])
        ...
        while True:
            try:
                ...
                if item == 'menu' or item == 'm':  # แสดงรายการเมนู
                    ...
                    price = int(
                        input(f'แก้ไขราคา จาก {self.menu[idx]["price"]} บาท เป็น -> : '))
