...
from rich.box import HEAVY , HEAVY_EDGE , MINIMAL , SIMPLE , DOUBLE , SQUARE
...
class Register(Console):
    ...
    def __login__(self) -> Dict[str , str]:   
        ...
        #* (function ย่อย) function ในการ login 
            ...
            while not bool(newUser["password"]):
                ...
                try:
                    ...
                    if isEmpty(password):
                        ...
                        raise UserWarning(f'❌ ความยาวของรหัสผ่านต้องมีความยาว {self.__PASSWORD_LENGTH__} ตัวขึ้นไป')
                    else:
    ...
    def __logout__(self , callbackFunction: Any) -> bool:
        ...
        if self.input('คุณต้องการออกจากบัญชีผู้ใช้งานนี้ (y/n) : ').lower().strip() == "y":
            ...
            self.print('⚠ คุณยกเลิกการออกจากบัญชีนี้' , style='orange1')
        return status
...
class Configuration(Register , Date , Console):
    ...
    def __accessDenide__(self , context: str) -> None:
        ...
        raise UserWarning('[bold red on grey3]⨉ คุณไม่มีสิทธิ์ที่จะใช้งานคำสั่งนี้ได้[/]')
...
class Program(Configuration , Date , Console): 
    ...
    def __init__(self , menu:List[Dict[str , str | int]] ) -> None:
        super().__init__() # set ค่า default parameters ใน superclass(Console) ที่ได้สืบทอดมาไม่งั้นจะไม่สามารถใช้ methods จาก superclass ได้
        ...
        user = super().__getUser__(callbackFunction=self.__log__) # login เสร็จจะได้ข้อมูล user
                            ...
                            while not bool(editItem["id"]):
                                try:
                                    ...
                                    if changeId.__len__() != self.__PRODUCTCODE_LENGTH__ and changeId != '-' and changeId != '/':
                                        raise UserWarning(f'❌ ต้องตั้งรหัสสินค้าในความยาวของ {self.__PRODUCTCODE_LENGTH__} เท่านั้น!')
                                    elif changeId == '-':
