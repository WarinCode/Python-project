...
class Program(Configuration):
    ...
    def notify(self , context: str , *args: Tuple[str | Any]) -> None: # แสดงข้อความเมื่อเรียกคำสั่งที่พิมพ์ไป
        ...
        while self.__programStatus__["isInvokeMethods"]:
            try:
                ...
                # ออกจาการทำงานของ method
                    ...
                    # ! เมื่อหยุดการทำงานของ function __placeOrder__ ให้เรียกใช้ function คำนวณสินค้า
                    calculateOrder()
