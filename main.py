...
class Register: #? องค์ประกอบใน class: ระบบ login , logout , สมัครสมาชิก , ผู้ใช้งาน , ข้อมูลผู้ใช้งาน
    ...
    def __logout__(self) -> bool:
        ...
        if input('คุณต้องการออกจากบัญชีผู้ใช้งานนี้ (y/n) : ').lower().strip() == "y":
            ...
            print('คุณออกจากบัญชีนี้เรียบร้อย')
        else:
...
class Configuration(Register): #? องค์ประกอบใน class: กำหนดโครงสร้างหลักๆของ class Program และ สิทธิ์การใช้งาน
    ...
    #! ข้อบังคับ: การเปิดใช้งาน(ใส่ True/False)บางอย่างจะต้องสอดคล้องกัน เช่น EnableRegisterSystem == EnableAccessPermissions
    __DEFAULTSETTING__ = {
                ...
                if self.isKeyword(command):
                    ...
                    #* ซื้ออาหาร
                        ...
                        if self.__user__["AccessPermissions"]["SellFood"]:
                            ...
                            raise UserWarning('⨉ คุณไม่มีสิทธิ์ที่จะใช้งานคำสั่งนี้ได้')
                    #* เพิ่มสินค้า
