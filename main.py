...
class Program:
    ...
    def showMenu(self):
        ...
        for item in self.menu:
            ...
            n += 1
        print(
            f"🌟 ตอนนี้ไม่มีรายการสินค้าใดๆโปรดเพิ่มสินค้าก่อนแสดงรายการเมนู!"
                ...
                if foodName == "m" or foodName == "menu":  # แสดงรายการเมนู
                    ...
                    while True:
                        try:
                            ...
                            break
                    if (
                        foodName not in self.currentOrder
                ...
                if item == "e" or item == "end":  # ออกจาการทำงานของ function
                    ...
                    for element in formatList:
                        if element in self.foodList:
                            ...
                            deleteElements(element)
                        elif (element not in self.foodList) and (
                            int(element) not in self.idList
                        ):
                            raise UserWarning(
