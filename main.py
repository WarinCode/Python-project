        ...
        while True:
            ...
            if isEnd:
                ...
                if self.order.__len__() != 0: 
                    ...
                    #  เริ่มสั่งรายการใหม่ลบสินค้า order ปัจจุบันออก
                    self.order.clear()
                    showOrder.clear()
                break
    ...
    def addItems(self):
        ...
        while True:
            try:
                ...
                if foodName == "e" or foodName == "end": # ออกจาการทำงานของ function 
                    break
                elif foodName == "m" or foodName == "menu": # แสดงรายการเมนู
                    self.showMenu()
                    continue
    ...
    def removeItems(self):
        ...
        while True:
            ...
            try:
                ...
                inp = inp.lower().strip() 
                if inp == 'e' or inp == 'end':  # ออกจาการทำงานของ function
                    break
                elif inp == 'm' or inp == 'menu': # แสดงรายการเมนู
                    self.showMenu()
    ...
    def editItems(self):
        ...
        while True:
            try:
                ...
                inp = inp.lower()
                if inp == 'end' or inp == 'e': # ออกจาการทำงานของ function
                    break
                if inp == 'menu' or inp == 'm': # แสดงรายการเมนู
                    self.showMenu()
                    continue
                else:
